...
from NadiasBot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from NadiasBot.modules import ALL_MODULES
from NadiasBot.modules.helper_funcs.chat_status import is_user_admin
from NadiasBot.modules.helper_funcs.misc import paginate_modules
...
NadiasBot_IMG = "https://telegra.ph/nadiasbotbackground-01-29"

DONATE_STRING = """Heya, glad to hear you want to donate!
NadiasBot is hosted on its own server and doesn't require any donations as of now but \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("NadiasBot.modules." +
                                              module_name)
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         InlineKeyboardButton(
                             text="Source code",
                             url="https://github.com/Naacha588/ProjectNadiaPart2")
                     ]]))
    else:
