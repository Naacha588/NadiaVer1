...
import NadiasBot.modules.sql.global_bans_sql as gban_sql
import NadiasBot.modules.sql.users_sql as user_sql
from NadiasBot import DEV_USERS, OWNER_ID, dispatcher
