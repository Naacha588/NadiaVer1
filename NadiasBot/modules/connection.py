...
import NadiasBot.modules.sql.connection_sql as sql
from NadiasBot import dispatcher, DRAGONS, DEV_USERS
from NadiasBot.modules.helper_funcs import chat_status
