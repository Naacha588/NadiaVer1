...
import telegram
from NadiasBot import WOLVES, dispatcher
from NadiasBot.modules.disable import DisableAbleCommandHandler
from NadiasBot.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           is_user_admin,
                                                           user_admin,
                                                           user_admin_no_reply)
...
from NadiasBot.modules.helper_funcs.string_handling import split_quotes
from NadiasBot.modules.log_channel import loggable
from NadiasBot.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # NadiasBot's sticker
        keyboard = None
