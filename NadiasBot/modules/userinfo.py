...
from NadiasBot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, WOLVES,
                          INFOPIC, dispatcher, sw)
from NadiasBot.__main__ import STATS, TOKEN, USER_INFO
import NadiasBot.modules.sql.userinfo_sql as sql
from NadiasBot.modules.disable import DisableAbleCommandHandler
from NadiasBot.modules.sql.global_bans_sql import is_user_gbanned
from NadiasBot.modules.sql.afk_sql import is_afk, check_afk_status
from NadiasBot.modules.sql.users_sql import get_user_num_chats
from NadiasBot.modules.helper_funcs.chat_status import sudo_plus
from NadiasBot.modules.helper_funcs.extraction import extract_user
from NadiasBot import telethn as NadiasBotTelethonClient, DRAGONS, DEMONS
