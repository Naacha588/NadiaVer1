...
import NadiasBot.modules.sql.notes_sql as sql
from NadiasBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from NadiasBot.__main__ import DATA_IMPORT
from NadiasBot.modules.helper_funcs.chat_status import user_admin
from NadiasBot.modules.helper_funcs.alternate import typing_action

# from NadiasBot.modules.rules import get_rules
import NadiasBot.modules.sql.rules_sql as rulessql

# from NadiasBot.modules.sql import warns_sql as warnssql
import NadiasBot.modules.sql.blacklist_sql as blacklistsql
from NadiasBot.modules.sql import disable_sql as disabledsql

# from NadiasBot.modules.sql import cust_filters_sql as filtersql
# import NadiasBot.modules.sql.welcome_sql as welcsql
import NadiasBot.modules.sql.locks_sql as locksql
from NadiasBot.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @Yoona0987"
            )
...
def export_data(update, context):
    ...
    f = open("NadiasBot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("NadiasBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `NadiasBot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("NadiasBot{}.backup".format(chat_id))  # Cleaning file
